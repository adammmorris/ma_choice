...
[data_WAD, data_WP, data_EW, data_TAL, data_LEX] = generateData(numChoices, numAgents, numAtts, numValuesPerAtt, inv_temp, weights, weights_signed, weights_lex);
[data_WAD_test, data_WP_test, data_EW_test, data_TAL_test, data_LEX_test] = generateData(numChoices, numAgents, numAtts, numValuesPerAtt, inv_temp, weights, weights_signed, weights_lex);
